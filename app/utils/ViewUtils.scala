...
object ViewUtils {
  ...
  def h2Component(msg: String,
                  id: Option[String] = None,
                  h2Class: Option[String] = None): HtmlFormat.Appendable = {
  ...
  def pComponent(content: Html,
                 ...
                 tabLink: Option[Html] = None)(implicit messages: Messages): HtmlFormat.Appendable = {
    new p().apply(
      content = content,
      id = id,
      classes = classes,
  ...
  def insetComponent(msg: String,
                     id: Option[String] = None,
                     classes: Option[String] = None)(implicit messages: Messages): HtmlFormat.Appendable = {
    new inset().apply(
      msg = msg,
      id = id,
      classes = classes)
  ...
  def captionComponent(msg: String,
                       id: Option[String] = None,
                       classes: String): HtmlFormat.Appendable = {
    new caption().apply(
      msg = msg,
      id = id,
      classes = classes)
  ...
  def hmrcNewTabLinkComponent(text: String = emptyString,
                              href: Option[String] = None,
                              language: Option[String] = None,
                              classList: Option[String] = None): HtmlFormat.Appendable = {
