...
class ErrorHandlerSpec extends SpecBase {
  ...
  "unauthorized" should {
    ...
    "display template with correct contents" in new Setup {
      ...
      errorHandler.unauthorized() mustBe errorTemplateView.apply(
  ...
  "standardErrorTemplate" should {
    ...
    "display template with correct contents" in new Setup {
      ...
      errorHandler.standardErrorTemplate() mustBe errorTemplateView.apply(
  ...
  "sddsErrorTemplate" should {
    ...
    "display template with correct contents" in new Setup {
      ...
      errorHandler.sddsErrorTemplate() mustBe errorTemplateView.apply(
  ...
  "contactDetailsErrorTemplate" should {
    ...
    "display template with correct contents" in new Setup {
      ...
      errorHandler.contactDetailsErrorTemplate() mustBe errorTemplateView.apply(
  ...
  "errorUpdatingContactDetails" should {
    ...
    "display template with correct contents" in new Setup {
      ...
      errorHandler.errorUpdatingContactDetails() mustBe editUpdateTemplateView.apply(
        messages("accountDetails.edit.error.title"),
        messages("accountDetails.edit.error.heading"),
        messages("accountDetails.edit.error.message")
      )
